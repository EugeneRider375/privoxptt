...
interface AppStore {
  ...
  removeDispatcherCall: (callId: string) => void;
  clearDispatcherCalls: () => void;
...
export const useStore = create<AppStore>()(
  persist(
    (set, get) => ({
      ...
      removeDispatcherCall: (callId) =>
        set((s) => ({ dispatcherCalls: s.dispatcherCalls.filter((c) => c.callId !== callId) })),
      clearDispatcherCalls: () => set({ dispatcherCalls: [] }),
