...
import { X, AlertTriangle, Info, Radio, PhoneCall, MessageSquare, Bell, ChevronDown, Thermometer, MapPin } from 'lucide-react';
...
const icons = {
  ...
  arrival: <MapPin className="w-4 h-4 text-ptt-green" />,
};
...
const colors = {
  ...
  arrival: 'border-ptt-green/40 bg-ptt-green/10',
};
